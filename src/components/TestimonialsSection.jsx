    ...
    <section className="py-32 bg-transparent relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 font-geometric text-text-primary">Trusted by 16,000+ Professionals</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <p className="text-text-primary/80 italic mb-8 leading-relaxed">"{t.quote}"</p>
              
              <div className="flex items-center gap-4 pt-6 border-t border-border-custom">
                <img src={t.image} alt={t.author} className="w-12 h-12 rounded-full border border-border-custom" />
                <div>
