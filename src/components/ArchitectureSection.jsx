...
const ArchitectureSection = () => {
  return (
    <section id="platform" className="py-32 bg-transparent relative overflow-hidden">
      <div className="absolute inset-0 bg-secondary/5 -z-10" />
      
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-24">
          <h2 className="text-4xl md:text-6xl font-bold mb-6 font-geometric text-text-primary">Platform Architecture</h2>
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-between gap-12 py-20">
          ...
          >
            <div className="w-24 h-24 rounded-3xl bg-surface border border-border-custom flex items-center justify-center glow-primary mb-6">
              <User className="w-10 h-10 text-primary" />
            </div>
            <h3 className="text-xl font-bold mb-2 text-text-primary">Sender Identity</h3>
            <p className="text-xs text-text-secondary text-center max-w-[150px]">Single source of truth for all your professional data.</p>
          </motion.div>

          <ArrowRight className="hidden md:block w-8 h-8 text-text-primary/20 animate-pulse" />
          ...
          >
            <div className="relative">
              ...
              <div className="w-32 h-32 rounded-4xl bg-linear-to-br from-primary to-secondary p-1 relative">
                <div className="w-full h-full rounded-3xl bg-background flex items-center justify-center">
                  <Cpu className="w-12 h-12 text-text-primary" />
                </div>
              </div>
            </div>
            <h3 className="text-xl font-bold mt-8 mb-2 text-text-primary">Gouji Intelligence</h3>
          ...
          <motion.div 
            ...
            className="z-10 flex flex-col items-center"
          >
            <div className="w-24 h-24 rounded-3xl bg-surface border border-border-custom flex items-center justify-center glow-secondary mb-6">
              <Users className="w-10 h-10 text-secondary" />
            </div>
            <h3 className="text-xl font-bold mb-2 text-text-primary">Personalized UI</h3>
        ...
        <div className="mt-32 grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="p-6 glass-card">
              ...
              <h4 className="font-bold mb-2 text-text-primary">{item.t}</h4>
