  ...
  return (
    <SectionContainer id="pricing">
      <div className="text-center mb-20">
        <h2 className="text-4xl md:text-6xl font-bold mb-6 font-geometric text-white">Simple, Transparent Pricing.</h2>
      ...
      <div className="mt-20 p-8 glass-card border-white/5 flex flex-col md:flex-row items-center justify-between gap-8">
        <div className="flex items-center gap-6">
          <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center text-primary">
            <Shield className="w-6 h-6" />
          </div>
          <div>
            <h4 className="font-bold text-white">1 Card Every Year</h4>
