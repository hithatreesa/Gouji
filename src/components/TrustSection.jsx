...
const TrustSection = () => {
  ...
  return (
    <div className="py-32 relative z-20 md:-mt-32 bg-transparent">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {metrics.map((metric, i) => (
            ...
            >
              <div className="text-3xl md:text-5xl font-bold text-text-primary mb-2 font-geometric">
        ...
        <div className="mt-20 flex flex-wrap justify-center items-center gap-12 grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all duration-700">
          {['Stitch', 'Vercel', 'Linear', 'Replicate', 'Retool'].map((logo) => (
            <span key={logo} className="text-2xl font-bold text-text-primary tracking-tighter">
              {logo}
            </span>
          ))}
        </div>
